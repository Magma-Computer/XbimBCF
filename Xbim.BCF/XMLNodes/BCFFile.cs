	...
	public class BCFFile
	{
		...
		public string IfcProject
		{
			...
			set
			{
				...
				{
					throw new ArgumentException(GetType().Name + " - IFCProject - IFCguid must be 22 chars exactly");
				}
			}
		}
		...
		public string IfcSpatialStructureElement
		{
			...
			set
			{
				...
				{
					throw new ArgumentException(GetType().Name + " - IfcSpatialStructureElement - IFCguid must be 22 chars exactly");
				}
			}
		}
